...
if(isset($_POST['submit'])){
    ...
    $file_path = "books/".$filename;
        $sql = "INSERT INTO products (name,pix,price,author,details,category) VALUES ('$name','$file_path','$price','$author','$details','$select')";
        $result = $conn->query($sql);
        if($result===true){
            $success="<div class='alert alert-success'>Book Successfully Uploaded</div>";
            move_uploaded_file($file_tmp,$file_path);
        }else{
            $error="<div class='alert alert-danger'>Book Not Successfully Uploaded</div>";
        }
}
?>
...
<div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="kode-navigation">
                            <ul>
                                <li>
                                    <a href="Add Product - My ASP.NET Application.html">ADD PRODUCT</a>
                                </li>
                                <li>
                                    <a href="Add Product - My ASP.NET Application.html">REGISTERED USERS</a>
                                </li>
                                <li>
                                    <a href="Add Product - My ASP.NET Application.html">BOOKS</a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="container">
        ...
        <form action="add%20product.php" enctype="multipart/form-data" method="post" novalidate>
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="Pix">Pix</label>
                    <div class="col-md-4">
                        <input type="file" name="file_img" accept=".jpg,.jpeg,.png,.gif,.pdf" onchange="showMyImage(this)">
                        <img id="thumbnil" class="center-block" style="width:50%; margin-top:10px;" src="./Add Product - My ASP.NET Application_files/contactpic.png" alt="image">


                        <span class="field-validation-valid" data-valmsg-for="Pix" data-valmsg-replace="true"></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="text-box single-line" data-val="true" data-val-number="The field Price must be a number." data-val-required="The Price field is required." id="Price" name="price" type="text" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea cols="20" id="Details" name="details" rows="2"></textarea>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-2">
                        <input type="submit" value="Create" name="submit" class="reg-btn">
                    </div>
                </div>
            </div>
        </form>
